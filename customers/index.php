...
<body>
	...
	<nav class="navbar">
		<div class="container-fluid">
			...
			<li class="nav-item"><a class="nav-link" href="/pandapaints/salesorder/">Sales Order</a></li>
			<li class="nav-item active"><a class="nav-link" href="/pandapaints/customers/">Customers</a></li>
